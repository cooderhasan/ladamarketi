...
export function CartClient({ bankTransferDiscountRate = 0 }: CartClientProps) {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            {/* Info Banner about Bank Transfer Discount */}
            {discountRate === 0 && bankTransferDiscountRate > 0 && (
                <div className="bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-800/50 rounded-xl p-4 mb-6 flex items-center gap-3 animate-in fade-in slide-in-from-top-2 duration-300">
                    <div className="p-2 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg text-emerald-800 dark:text-emerald-300">
