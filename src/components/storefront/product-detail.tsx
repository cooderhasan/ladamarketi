                                ...
                                {product.stock > 0 ? (
                                    <>
                                        ...
                                        <div className="flex items-center gap-3">
                                            {/* Quantity selector */}
                                            <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shrink-0">
                                                <Button
                                                    variant="ghost"
                                                    size="icon"
                                                    className="h-10 w-10 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700"
                                                ...
                                                <Input
                                                    ...
                                                    onFocus={handleFocus}
                                                    className="w-12 text-center border-none bg-transparent h-10 text-sm font-bold focus-visible:ring-0 p-0"
                                                />
                                                <Button
                                                    variant="ghost"
                                                    size="icon"
                                            ...
                                            {/* Add to Cart Button */}
                                            <Button
                                                className="flex-1 h-12 text-base font-bold bg-[#009AD0] hover:bg-[#007baa] text-white rounded-lg transition-all active:scale-[0.98] shadow-lg shadow-[#009AD0]/20"
